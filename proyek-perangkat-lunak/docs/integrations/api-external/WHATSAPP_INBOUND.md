...
Dokumentasi ini menjelaskan endpoint internal [`POST /internal/wa/inbound`](../../backend/src/app.ts:225) pada backend Smart Task Planner.
...
Endpoint [`POST /internal/wa/inbound`](../../backend/src/app.ts:225) digunakan untuk:
...
- [`handleWhatsappInbound()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:451)
- [`sendWhatsappMessage()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:38)
- [`sendWhatsappRegistrationSuccess()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:101)
- [`detectWhatsappIntent()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:238)
- [`findBestTaskMatch()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:326)
- [`buildListMessage()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:301)
- [`buildOverviewMessage()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:217)
- [`handleTaskCompletion()`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:393)
- [`AiService.parseTaskCommand()`](../../backend/src/modules/ai/ai.service.ts:175)
- [`AiService.resolveWhatsappAction()`](../../backend/src/modules/ai/ai.service.ts:283)
- [`applyIndonesianTimeHints()`](../../backend/src/modules/ai/ai.service.ts:128)
- [`TaskService.processWhatsappDeadlineReminders()`](../../backend/src/modules/tasks/task.service.ts:404)
- [`TaskService.autoSkipOverdueTasks()`](../../backend/src/modules/tasks/task.service.ts:328)
- [`TaskAutoSkipScheduler.run()`](../../backend/src/modules/tasks/task.auto-skip.scheduler.ts:46)
- route registration di [`createApp()`](../../backend/src/app.ts:14)
...
Validasi dilakukan di [`handleWhatsappInbound()`](../../backend/src/app.ts:232) sampai [`handleWhatsappInbound()`](../../backend/src/app.ts:243).

### Aturan Auth

- Jika [`TOKEN_WHATSAPP`](../../backend/src/config/env.ts) belum dikonfigurasi, endpoint mengembalikan HTTP `500`.
...
Validasi ada di [`handleWhatsappInbound()`](../../backend/src/app.ts:261).
...
Command registrasi dikenali dengan regex [`/^(\S+)\s+daftar$/i`](../../backend/src/app.ts:271).
...
Flow utama dimulai di [`handleWhatsappInbound()`](../../backend/src/app.ts:116).
...
- field [`whatsappNumber`](../../backend/src/app.ts:130) user masih kosong/null,
- nomor pengirim tidak sedang dipakai user lain.

Aksi backend:

1. normalisasi nomor WhatsApp,
2. cek konflik nomor dengan user lain di [`handleWhatsappInbound()`](../../backend/src/app.ts:190),
3. update user dengan:
   - `whatsappNumber`
   - `whatsappChatId`
4. kirim pesan sukses via [`sendWhatsappRegistrationSuccess()`](../../backend/src/app.ts:62).
...
Sumber pesan ada di [`sendWhatsappRegistrationSuccess()`](../../backend/src/app.ts:62).
...
Implementasi ada di [`handleWhatsappInbound()`](../../backend/src/app.ts:136).
...
Implementasi ada di [`handleWhatsappInbound()`](../../backend/src/app.ts:163).
...
Implementasi ada di [`handleWhatsappInbound()`](../../backend/src/app.ts:198).
...
Implementasi ada di [`handleWhatsappInbound()`](../../backend/src/app.ts:119).
...
- backend menerima payload lewat [`POST /internal/wa/inbound`](../../backend/src/app.ts:225),
...
- `CREATE_TASK` → gunakan flow setara create task / [`POST /api/tasks`](../../backend/README.md)
...
Parser AI task sekarang memakai normalisasi waktu Indonesia/Jakarta di [`applyIndonesianTimeHints()`](../../backend/src/modules/ai/ai.service.ts:128). Tujuannya agar frasa natural seperti berikut tidak bergeser ke timezone server:
...
Helper [`getJakartaDateParts()`](../../backend/src/modules/ai/ai.service.ts:85) dan [`createJakartaDate()`](../../backend/src/modules/ai/ai.service.ts:110) dipakai untuk memastikan input Indonesia dibentuk sebagai waktu `Asia/Jakarta`, bukan waktu lokal server yang bisa berbeda.

### Reminder WhatsApp personal berbasis scheduler

Reminder deadline personal tidak diproses di endpoint inbound, tetapi oleh scheduler backend yang otomatis dijalankan saat server start di [`startServer()`](../../backend/src/server.ts:8).

Komponen utamanya:

- interval scheduler: [`AUTO_SKIP_INTERVAL_MS`](../../backend/src/modules/tasks/task.auto-skip.scheduler.ts:4)
- loop utama reminder + auto-skip: [`TaskAutoSkipScheduler.run()`](../../backend/src/modules/tasks/task.auto-skip.scheduler.ts:46)
- sender outbound personal: [`sendWhatsappMessage()`](../../backend/src/modules/tasks/task.auto-skip.scheduler.ts:27)
- query candidate reminder: [`TaskService.processWhatsappDeadlineReminders()`](../../backend/src/modules/tasks/task.service.ts:404)
- auto-skip overdue: [`TaskService.autoSkipOverdueTasks()`](../../backend/src/modules/tasks/task.service.ts:328)
- dedup flag update: [`TaskService.markWhatsappReminderSent()`](../../backend/src/modules/tasks/task.service.ts:521) dan [`TaskService.markSkippedNotificationSent()`](../../backend/src/modules/tasks/task.service.ts:532)
...
Dedup reminder disimpan pada field schema task di [`schema.prisma`](../../backend/prisma/schema.prisma):
...
```text
✅ Task berhasil dibuat untuk Bayu:
📝 Meeting dengan tim produk
🕒 13 Jun 2026, 21.00
⚡ HIGH
📌 PENDING
```
...
```json
{
  ...
  "data": {
    "source": "whatsapp",
    "service": "internal-wa",
    "command": "task tambah meeting besok jam 10 malam",
...
Flow WhatsApp ini **tidak** memanggil endpoint web-auth biasa seperti [`/api/tasks`](../../backend/src/modules/tasks/task.routes.ts) melalui HTTP internal. Endpoint [`POST /internal/wa/inbound`](../../backend/src/modules/whatsappInbound/whatsapp-inbound.routes.ts:451) langsung menggunakan service internal backend:

- [`AiService.parseTaskCommand()`](../../backend/src/modules/ai/ai.service.ts:175)
- [`AiService.resolveWhatsappAction()`](../../backend/src/modules/ai/ai.service.ts:283)
- [`TaskService.createTask()`](../../backend/src/modules/tasks/task.service.ts:10)
- [`TaskService.getTasks()`](../../backend/src/modules/tasks/task.service.ts:51)
- [`TaskService.updateTask()`](../../backend/src/modules/tasks/task.service.ts:93)
- [`TaskService.updateTaskStatus()`](../../backend/src/modules/tasks/task.service.ts:148)
- [`TaskService.deleteTask()`](../../backend/src/modules/tasks/task.service.ts:171)
- [`TaskService.getTaskStats()`](../../backend/src/modules/tasks/task.service.ts:187)
- [`TaskService.getDailyTaskStats()`](../../backend/src/modules/tasks/task.service.ts:197)
...
- jalankan migration atau [`prisma db push`](../../backend/README.md:271) untuk field dedup reminder terbaru,
