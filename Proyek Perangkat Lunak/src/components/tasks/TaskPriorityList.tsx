    ...
    <div className="space-y-6">
      ...
      {filteredTasks.length > 0 && (
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="bg-gradient-to-br from-blue-50/50 to-cyan-50/50 dark:from-blue-950/20 dark:to-cyan-950/20 border border-blue-100/50 dark:border-blue-900/50 rounded-2xl p-4 backdrop-blur-sm">
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-widest mb-2">Total Tasks</p>
            <p className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
              {filteredTasks.length}
            </p>
          </div>
          <div className="bg-gradient-to-br from-orange-50/50 to-red-50/50 dark:from-orange-950/20 dark:to-red-950/20 border border-orange-100/50 dark:border-orange-900/50 rounded-2xl p-4 backdrop-blur-sm">
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-widest mb-2">High Priority</p>
            <p className="text-3xl font-bold text-orange-600 dark:text-orange-400">
              {filteredTasks.filter(t => t.priority === 'HIGH').length}
            </p>
          </div>
          <div className="bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-100/50 dark:border-green-900/50 rounded-2xl p-4 backdrop-blur-sm">
            <p className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-widest mb-2">Avg Score</p>
