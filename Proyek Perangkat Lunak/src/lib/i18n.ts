...
export const translations = {
  ...
  id: {
    ...
    landing: {
      ...
      features: {
        aiPowered: 'Perencanaan Bertenaga AI',
        aiPoweredDesc: 'Pahami bahasa kasual dan input alami dengan parsing AI canggih',
        smartAutomation: 'Otomasi Cerdas',
        smartAutomationDesc: 'Pengurangan 70% dalam pembuatan tugas manual dengan pengenalan pola',
        wearableIntegration: 'Integrasi Wearable',
        wearableIntegrationDesc: 'Pengingat haptic dan sinkronisasi real-time di semua perangkat Anda',
        productivityInsights: 'Wawasan Produktivitas',
        productivityInsightsDesc: 'Analitik berbasis data untuk mengoptimalkan alur kerja Anda',
      },
      ...
      feature1: 'Otomasi Tugas Cerdas',
      feature1Meta: 'Phase 1.5 • Pengurangan 70%',
      feature1Text: 'AI mempelajari pola dan secara otomatis membuat tugas berulang dengan akurasi 95%',
      feature2: 'Asisten Tugas AI',
      feature2Meta: 'Phase 1 • Alokasi waktu 40% lebih baik',
      feature2Text: 'Antarmuka chat untuk bantuan perencanaan dan optimasi tugas yang cerdas',
      feature3: 'Saran Cerdas',
      feature3Meta: 'Phase 1.5 • AI real-time',
      feature3Text: 'Rekomendasi yang sadar konteks berdasarkan beban kerja dan ketersediaan',
      feature4: 'Mode Fokus',
      feature4Meta: 'Phase 1 • Peningkatan 40%',
      feature4Text: 'Time blocking dan sesi kerja dalam dengan deteksi konflik',
      feature5: 'Habit Stacking',
      feature5Meta: 'Phase 1.5 • 3x lebih tinggi',
      feature5Text: 'Bangun kebiasaan bertahan dengan menumpukannya ke tugas yang ada dengan streaks',
      feature6: 'Penyeimbangan Beban Kerja',
      feature6Meta: 'Phase 2 • Burnout ↓ 60%',
      feature6Text: 'AI memantau dan mencegah burnout dengan distribusi beban kerja yang cerdas',
      feature7: 'Tenggat Waktu Cerdas',
      feature7Meta: 'Phase 1.5 • Penyelesaian ↑ 40%',
      feature7Text: 'AI menantang tenggat waktu yang tidak realistis sebelum komitmen',
      feature8: 'Sinkronisasi Lintas Perangkat',
      feature8Meta: 'Phase 2 • Sinkronisasi real-time',
      feature8Text: 'Sinkronisasi mulus di web, mobile, wearable, dan smart home',
      feature9: 'Analitik & Wawasan',
      feature9Meta: 'Phase 2 • Peningkatan 20%',
      feature9Text: 'Dashboard indah dengan pola dan wawasan produktivitas',
      feature10: 'Kolaborasi Tim',
      feature10Meta: 'Phase 2 • Enterprise',
      feature10Text: 'Ruang kerja bersama dengan distribusi tugas bertenaga AI untuk tim',
