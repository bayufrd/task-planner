      ...
      <div class="w-full max-w-md relative z-10">
        <div :class="['rounded-3xl shadow-xl shadow-black/10 dark:shadow-black/30 border transition-colors p-8 space-y-8', uiStore.state.theme === 'dark' ? 'bg-gray-800/80 border-gray-700/50' : 'bg-white/80 border-gray-200/50']">
          <div class="space-y-5 text-center">
            ...
            <div class="space-y-2">
              <h1 :class="['text-3xl font-bold', uiStore.state.theme === 'dark' ? 'text-white' : 'text-gray-900']">Welcome Back</h1>
              <p :class="['text-sm', uiStore.state.theme === 'dark' ? 'text-gray-400' : 'text-gray-600']">Sign in to continue managing your tasks</p>
            </div>
          </div>
          ...
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <div class="relative rounded-lg border border-gray-300 dark:border-gray-700">
                ...
                <input v-model="form.password" type="password" required class="w-full pl-10 pr-4 py-3 bg-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter your password" />
              </div>
            </div>
